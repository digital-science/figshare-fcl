...
import { Button, IconButton, GenericButton} from "@digital-science/figshare-fcl/button";
...
import * as ToggletipStories from "./index.stories.jsx";
...
<Canvas of={ToggletipStories.Overview} />

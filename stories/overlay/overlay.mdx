...
import { Overlay, OverlayHeader, OverlayFooter, OverlayContent, PrimaryActions, SecondaryActions } from "@digital-science/figshare-fcl/overlay";
import * as OverlayStories from "./overlay.stories.jsx";
...
<Canvas of={OverlayStories.Overview} />
...
### OverlayHeader
<ArgTypes of={OverlayHeader} />

### OverlayContent
<ArgTypes of={OverlayContent} />

### OverlayFooter
<ArgTypes of={OverlayFooter} />

### OverlayFooter.Primary
<ArgTypes of={PrimaryActions} />

### OverlayFooter.Secondary
<ArgTypes of={SecondaryActions} />


## Examples

<Canvas of={OverlayStories.Examples} />
